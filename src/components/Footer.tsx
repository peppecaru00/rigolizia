  ...
  return (
    <footer className="bg-[#1a0f0a] text-white pt-[var(--space-3xl)] pb-[var(--space-xl)]">
      <div className="container mx-auto px-14 max-w-[1440px]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20 mb-20 fade-in">
          <div className="flex flex-col gap-6">
            <h3 className="font-heading font-semibold text-[clamp(1.5rem,3vw,2rem)] text-[#DBBE85] mb-4">Rigolizia</h3>
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3 list-none p-0 m-0">
              <li>
                <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="font-body text-white/70 hover:text-[#B85C38] transition-colors">
                  Facebook
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="font-body text-white/70 hover:text-[#B85C38] transition-colors">
                  Instagram
                </a>
              </li>
            </ul>
